...
<title>{name}</title>
    ...
    content_base = """<div id="dowwner-content">
{content}
</div>"""

    content = ""

    navigation_base = """<div id="dowwner-nav">
{nav}
</div>"""
    ...
    def body(self):
        return "\n".join(("<body>",
                          self.content_base.format(content=self.content),
                          """<hr id="dowwner-sep"/>""",
                          self.navigation_base.format(nav=self.navigation),
                          "</body>"))
